 ...
 */
class Admin_Form_Section extends Admin_Form_Base
{
	public function init()
	{
		$this->setName('section');

		$name = new Zend_Form_Element_Text('sec_name');
		$name->setLabel('name')
			->setRequired(true)
			->addFilter('StripTags')
			->addFilter('StringTrim');

		$description = new Zend_Form_Element_Textarea('sec_description');
		$description->setLabel('description')
			->setRequired(true)
			->addFilter('StripTags')
			->addFilter('StringTrim');

		$code = new Zend_Form_Element_Text('sec_code');
		$code->setLabel('code')
			//->setRequired(true)
			->addFilter('StripTags')
			->addFilter('StringTrim');

		$tags = new Zend_Form_Element_Text('sec_tags');
		$tags->setLabel('tags')
			//->setRequired(true)
			->addFilter('StripTags')
			->addFilter('StringTrim');

		$publish = new Zend_Form_Element_Select('sec_publish');
