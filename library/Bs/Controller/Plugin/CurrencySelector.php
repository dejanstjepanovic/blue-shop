 ...
 */
class Bs_Controller_Plugin_CurrencySelector extends Zend_Controller_Plugin_Abstract
{
	/* (non-PHPdoc)
	...
	public function preDispatch(Zend_Controller_Request_Abstract $request)
	{
		...
		$view->formCurrency = new Form_ChangeCurrency();
		
		$userCurrency = Zend_Registry::get('visitor_data')->currency;
		$view->formCurrency->populate(array('currency'=>$userCurrency));
	}
}
