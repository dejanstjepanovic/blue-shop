 ...
 */
class Bs_Controller_Plugin_LangSelector extends Zend_Controller_Plugin_Abstract
{
	/* (non-PHPdoc)
	...
	public function preDispatch(Zend_Controller_Request_Abstract $request)
	{
		...
		$translate = new Zend_Translate('csv', APPLICATION_PATH . '/configs/langs/' . $lang . '.csv', $lang);
