...
class CommentControllerTest extends Zend_Test_PHPUnit_ControllerTestCase
{
    ...
    {
        $params = array('action' => 'vote', 'controller' => 'Comment', 'module' => 'default');
        $urlParams = $this->urlizeOptions($params);
        $url = $this->url($urlParams);
        $this->dispatch($url);
    ...
    {
        $params = array('action' => 'preview', 'controller' => 'Comment', 'module' => 'default');
        $urlParams = $this->urlizeOptions($params);
        $url = $this->url($urlParams);
        $this->dispatch($url);
    ...
    {
        $params = array('action' => 'edit', 'controller' => 'Comment', 'module' => 'default');
        $urlParams = $this->urlizeOptions($params);
        $url = $this->url($urlParams);
        $this->dispatch($url);
